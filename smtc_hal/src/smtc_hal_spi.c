...
/* Forward declaration — declared in board support but not in any included header */
extern void system_spi_write_read(const uint8_t* cbuffer, uint8_t* rbuffer, uint16_t length);
